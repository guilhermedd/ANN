...
double f(double lambda_value) {
    return P1 - P0 * exp(lambda_value) - nu/lambda_value * (exp(lambda_value) - 1);
}

double df(double lambda_value) {
    double P0 = 1071145;
    double nu = 393564;
    return -P0 * exp(lambda_value) - nu/lambda_value * exp(lambda_value) + nu/pow(lambda_value, 2) * (exp(lambda_value) - 1);
}
