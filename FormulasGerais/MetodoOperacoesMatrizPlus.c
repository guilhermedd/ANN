...
void operacoes(double matriz[ROW][COL]){
    opercaoEmDuasLinhas(matriz, 1, 0, (2.0/3.0));
    opercaoEmDuasLinhas(matriz, 2, 0, 1.0);
    opercaoEmDuasLinhas(matriz, 3, 0, (8./3.0));
    opercaoEmDuasLinhas(matriz, 2, 1, (-9.0/4.0));
    opercaoEmDuasLinhas(matriz, 3, 1, (-11.0/4.0));
    opercaoEmDuasLinhas(matriz, 3, 2, (-179.0/177.0));
    imprimeMatriz(matriz);
}

int main(){
    double matriz[ROW][COL] = {
		{3, 3, 5, 2}, {-2, 2, -5, -3}, {-3, 6, 6, 3}, {-8, 3, -3, 3}
    };
