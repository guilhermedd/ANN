...
if __name__ == '__main__':
    ...
    matrix = [
        ...
        [52 / 100, 33 / 100, 19 / 100, areia],
        [33 / 100, 57 / 100, 35 / 100, cascalho_fino],
        [15 / 100, 10 / 100, 46 / 100, cascalho_grosso]
    ]
    ...
    print(solucao(matrix_escalonada)) #resposta